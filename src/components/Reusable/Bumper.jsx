    ...
    return (
        <div className='bg-[#cdea68] px-12 py-16 w-full h-[600px] flex gap-5 justify-center items-center rounded-[25px]'>
            ...
            <div className='w-1/2 h-[90%] flex gap-5'>
                <div className='w-1/2 bg-[#212121] rounded-xl flex items-center justify-center relative'>
                    <img src='./bumper/2.png' />
                ...
                <div className='bg-[#212121] w-1/2 rounded-xl flex items-center justify-center relative'>
                    <img className='w-28' src='./bumper/3.png' />
                    <div className='absolute bumper-btn bottom-5 left-5 border-[1px] px-3 rounded-3xl py-1'>
